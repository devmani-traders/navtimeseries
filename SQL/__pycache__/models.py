...
class FundFactSheet(db.Model):
    ...
    aum=db.Column(db.Float, nullable=True)
    # Investment terms
    ...
    benchmark_isin = db.Column(db.String(12),nullable=True)
...
class BSEScheme(db.Model):
    ...
    amc_code = db.Column(db.String(255), nullable=False, index=True)
...
# BSE SIP CODE
class BseSipcode(db.Model):
    __tablename__ = 'mf_bse_sipcode'
    id = db.Column(db.BigInteger, primary_key=True, autoincrement=True)
    scheme_code = db.Column(db.String(255), nullable=False)
    scheme_isin = db.Column(db.String(12), nullable=False)
    amc_code = db.Column(db.String(255), nullable=True)
    amc_name = db.Column(db.String(255), nullable=True)
    scheme_name = db.Column(db.String(255), nullable=True)
    sip_transaction_mode = db.Column(db.String(50), nullable=True)
    sip_frequency = db.Column(db.String(50), nullable=True)
    sip_dates = db.Column(db.String(255), nullable=True)
    sip_minimum_gap = db.Column(db.Integer, nullable=True)
    sip_maximum_gap = db.Column(db.Integer, nullable=True)
    sip_installment_gap = db.Column(db.Integer, nullable=True)
    sip_status = db.Column(db.String(50), nullable=True)
    sip_minimum_installment_amount = db.Column(db.Float, nullable=True)
    sip_maximum_installment_amount = db.Column(db.Float, nullable=True)
    sip_multiplier_amount = db.Column(db.Float, nullable=True)
    sip_minimum_installment_numbers = db.Column(db.Integer, nullable=True)
    sip_maximum_installment_numbers = db.Column(db.Integer, nullable=True)
    scheme_type = db.Column(db.String(50), nullable=True)
    pause_flag = db.Column(db.String(10), nullable=True)
    pause_minimum_installments = db.Column(db.Float, nullable=True)
    pause_maximum_installments = db.Column(db.Float, nullable=True)
    pause_modification_count = db.Column(db.Float, nullable=True)
    filler_1 = db.Column(db.String(255), nullable=True)
    filler_2 = db.Column(db.String(255), nullable=True)
    filler_3 = db.Column(db.String(255), nullable=True)
    filler_4 = db.Column(db.String(255), nullable=True)
    filler_5 = db.Column(db.String(255), nullable=True)
    created_at = db.Column(db.DateTime, default=datetime.utcnow)
    ...
    __table_args__ = (
        ...
        UniqueConstraint(
            ...
            name='uq_bse_sipcode_sip_profile'
        ),
        Index('idx_bse_sipcode_scheme_isin', 'scheme_isin'),
        Index('idx_bse_sipcode_amc_code', 'amc_code'),
        Index('idx_bse_sipcode_scheme_code', 'scheme_code'),
    )